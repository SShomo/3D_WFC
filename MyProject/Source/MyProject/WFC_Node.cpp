...
void AWFC_Node::ReduceToCompatibleTiles(TSet<TSharedRef<AWFC_Tile>> tiles)
{
...
TSet<TSharedRef<AWFC_Tile>> AWFC_Node::GetTiles()
{
	return mTiles;
}

void AWFC_Node::SetTiles(TSet<TSharedRef<AWFC_Tile>> tiles)
{
	mTiles = tiles;
}

void AWFC_Node::SetNeighbor(TSharedRef<AWFC_Node> node)
{
	mNeighbors.Add(node);
}

void AWFC_Node::SetNeighbors(TSet<TSharedRef<AWFC_Node>> nodes)
{
	mNeighbors = nodes;
}
...
{
	TSet<TSharedRef<AWFC_Tile>> tile = collapsingNode->GetTiles();
